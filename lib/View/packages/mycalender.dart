...
class CalendarWeek extends StatefulWidget {
  ...
  factory CalendarWeek(
          ...
          Color todayBackgroundColor = const Color.fromARGB(255, 80, 20, 211),
          Color pressedDateBackgroundColor = const Color(0xFF725ffe),
  ...
  Widget _monthItem(String title) => Align(
        ...
        child: Container(
            ...
            child: Text(
              title,
              style: TextStyle(
                  color: Colors.transparent, fontWeight: FontWeight.w600),
