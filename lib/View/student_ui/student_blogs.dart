...
class StudentBlogs extends StatefulWidget {
  const StudentBlogs({Key? key}) : super(key: key);

  @override
  State<StudentBlogs> createState() => _StudentBlogsState();
}

class _StudentBlogsState extends State<StudentBlogs> {
